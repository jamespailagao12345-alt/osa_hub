        ...
        <div class="col-md-9">
            ...
            <div class="page-section">
                <div class="card mt-4">
                    ...
                    <div class="card-body">
                        @php
                            // Check both user->image and student->personal_data_sheet_image
                            $student = \App\Models\Student::where('user_id', $user->id)->first();
                            $currentUserImage = $user->image ?? ($student ? $student->personal_data_sheet_image : null);
                            ...
                            if ($user->organization) {
                                $allOrganizations->push($user->organization);
                            }
                            
                            // Add many-to-many organizations if exists
                            if (method_exists($user, 'otherOrganizations') && $user->otherOrganizations) {
                        ...
                        <div class="row mb-4">
                            <div class="col-md-9">
                                <dl class="row mb-0">
                                    ...
                                    <dd class="col-sm-9">{{ $user->first_name }} {{ $user->middle_name ?? '' }} {{ $user->last_name }}</dd>
                                    ...
                                    <dd class="col-sm-9">{{ $user->course->name }}</dd>
                                    @endif
                                    ...
                                    <dd class="col-sm-9">{{ \Carbon\Carbon::parse($user->birth_date)->format('F d, Y') }}</dd>
                                    @endif
                                    
                                    @if($age)
                                    <dt class="col-sm-3">Age:</dt>
                                    <dd class="col-sm-9">{{ $age }} years old</dd>
                                    @endif
                                    ...
                                    <dt class="col-sm-3">Organization(s):</dt>
                                    <dd class="col-sm-9">
                            ...
                            <div class="col-md-3 d-flex flex-column justify-content-start align-items-center">
                                <div class="position-relative mb-3">
                                    @if($currentUserImage)
                                        <img id="profileImage" src="{{ \Illuminate\Support\Facades\Storage::disk('public')->url($currentUserImage) }}" 
                                             alt="{{ $currentUserName }}" 
                        ...
                        <dl class="row">
                            ...
                            <dd class="col-sm-9">{{ $user->emergency_contact_name ?? 'N/A' }} @if($user->emergency_contact_number)({{ $user->emergency_contact_number }})@endif</dd>
                        </dl>
                    ...
                    if (data.success) {
                        ...
                        if (cameraLabel) {
                            ...
                            if (icon) {
                                ...
                                icon.classList.add('bi-camera-fill');
                            }
                            cameraLabel.title = 'Upload Profile Image';
                        }
                    } else {
