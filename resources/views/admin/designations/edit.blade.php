...
<div class="container-fluid">
    <div class="row">
        ...
        <main id="adminMain" class="col-md-10">
            ...
            <h2 class="mb-3">Edit Designation</h2>
                ...
                <div class="card-body">
                    <form action="{{ route('admin.designations.update', $designation) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <small class="text-muted d-block mb-2">Select the features this designation can access:</small>
                            <div class="border rounded p-3" style="max-height: 400px; overflow-y: auto;">
                                @php
                                    ...
                                    $oldFeatures = old('features', $designation->features ?? []);
                                @endphp
