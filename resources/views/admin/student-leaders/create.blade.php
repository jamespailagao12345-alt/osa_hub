        ...
        <div class="card-body">
          ...
          <form method="POST" action="{{ route('admin.student-leaders.store') }}">
            ...
            <div class="d-flex gap-2">
              <button type="submit" class="btn btn-success" id="submit-btn">Add Student Leader</button>
              <a href="{{ route('admin.student-leaders.index') }}" class="btn btn-secondary">View All Student Leaders</a>
            </div>
          </form>
        </div>
      </div>
