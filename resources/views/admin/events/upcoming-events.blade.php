  ...
  <div class="row">
    ...
    <main class="col-md-10 py-4">
        ...
        <div class="py-3">
            ...
            <p class="text-muted small mb-3">Approved events, arranged according to dates (soonest first)</p>

            <!-- Search and Filter Form -->
            <form method="GET" action="{{ route('admin.events.upcoming') }}" class="mb-4">
                @if(request()->has('return_to'))
                ...
                @if(request()->hasAny(['search', 'description', 'organization_id']))
                    @if(request()->has('return_to'))
                      <a href="{{ route('admin.events.upcoming', ['return_to' => request('return_to')]) }}" class="btn btn-outline-secondary btn-sm">Clear Filters</a>
                    @else
                      <a href="{{ route('admin.events.upcoming') }}" class="btn btn-outline-secondary btn-sm">Clear Filters</a>
                    @endif
                @endif
            </form>
            ...
            <div class="mt-5">
                ...
                <p class="text-muted small mb-3">Upcoming events created by administrators</p>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td colspan="6" class="text-center py-4">
                                    <div class="text-muted">
                                        <i class="bi bi-info-circle me-2"></i>
                                        No admin-created upcoming events at the moment.
                                    </div>
                                </td>
                            </tr>
                            @endforelse
